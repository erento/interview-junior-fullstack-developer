...
describe('CityService', () => {
  ...
  describe('City Service', () => {
    ...
    it('should return all of the cities', async () => {
      ...
      jest.spyOn(cityService, 'getCities').mockResolvedValue(mockCities as never);
    ...
    it('should return all of the cities when the filter is ""', async () => {
      ...
      jest.spyOn(cityService, 'filterCities').mockResolvedValue(Array.from(mockCities)as never);

      const result = await cityService.filterCities("");

      expect(result.toString).toBe(mockCities.toString);
    });
    ...
    it('should return the cities which contains r letter', async () => {
      ...
      const result = await cityService.filterCities("r");
